...
##    return  # for quick debug tests
    ...
    strBroadcastAddress = '192.168.1.255'
...
#        bTriggerEvents = True
    ...
    try:
        ...
        custom_config_file = ''
        print 'Warning: Could not find config file "%s" for FPGA serial: %s' % (custom_config_file, initial_config.strSelectedSerial)
...
#   vco_freq_word_lsbs = np.bitwise_and(vco_freq_word, (1<<32)-1)
   ...
   # write amplitude
    ...
    dither_widget0 = DisplayDitherSettingsWindow(sl, 0, modulation_frequency_in_hz='50e3', output_amplitude='1e-5', integration_time_in_seconds='0.1', bEnableDither=True, custom_style_sheet=custom_style_sheet)
