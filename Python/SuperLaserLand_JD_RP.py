...
#    def openDevice(self, strIP):
#        
#        self.dev.OpenTCPConnection(strIP, 5000) # hack to get things working quickly
...
#
#        self.dev = RP_PLL.RP_PLL_device()
#        self.dev.OpenTCPConnection("192.168.2.8", 5000) # hack to get things working quickly
##        self.dev.OpenTCPConnection("192.168.1.101", 5000) # hack to get things working quickly
#        
#
#        self.dev_list = {}
#        
...
#             self.dev.ActivateTriggerIn(self.ENDPOINT_CMD_TRIG, self.TRIG_RESET)
        ...
        error_code = 0
        print('openDevice(): empty function')        
...
#     def read_raw_bytes_from_DDR2_legacy(self):
#         if self.bVerbose == True:
#             print('read_raw_bytes_from_DDR2_legacy')
            
#         if self.bCommunicationLogging == True:
#             self.log_file.write('read_raw_bytes_from_DDR2_legacy()\n')
...
#             print 'read_raw_bytes_from_DDR2 1: read_bytes = %d' % (read_bytes)
#             print repr(buffer_full_block[0:10])
